...
** You turn on routers by clicking on the actual device hitting the on button under the physical tab
** To delete connections use the x icon on packet tracer
